...
export default function Location() {
  return (
    <>
      ...
      <section id="location" className="w-full bg-background dark:bg-foreground text-foreground dark:text-muted min-h-screen flex flex-col justify-center py-12 md:py-0">
