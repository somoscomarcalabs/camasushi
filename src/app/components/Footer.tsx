      ...
      <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 md:px-8">
        <div className="flex flex-col items-center justify-between gap-6 sm:flex-row">
          <div className="text-center sm:text-left">
            <h3 className="text-lg font-bold text-primary">CamaSushi</h3>
            <p className="text-sm text-muted-foreground">123 Sushi Lane, Puerto Rico, Misiones</p>
          ...
          <div className="flex gap-4">
            <a
              ...
              aria-label="WhatsApp"
            >
              <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 432 432" xmlns="http://www.w3.org/2000/svg">
